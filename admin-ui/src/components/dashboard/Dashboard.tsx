        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-500 text-sm font-medium">Albums</p>
                  <p className="text-3xl font-bold text-gray-900 mt-2">{stats.albums}</p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-500 text-sm font-medium">Pending Validation</p>
                  <p className="text-3xl font-bold text-gray-900 mt-2">{stats.pendingValidation}</p>
                </div>
              ...
              {stats.pendingValidation > 0 && (
                <Button
                  ...
                  size="sm"
                  className="mt-4 w-full"
                  onClick={() => navigate('/page=vinco-mam-validation')}
                >
                  Review Queue
                </Button>
              )}
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-500 text-sm font-medium">Athletes</p>
                  <p className="text-3xl font-bold text-gray-900 mt-2">{stats.athletes}</p>
                </div>
